...
В конфиге уже есть аккаунт, но лучше использовать свой (необязательно).
Если токен устарел, то просто удалите token.json и запустите заново web или cmd версию, он заново создаст файл с токеном.
